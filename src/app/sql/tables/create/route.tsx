...
export async function GET(request: Request) {
    ...
    try {
        ...
        const create_table_team_result = await sql`CREATE TABLE Teams (Id SERIAL PRIMARY KEY, Name varchar(100) NOT NULL, SignedIn BIT NOT NULL, Paid BIT NOT NULL, EventCategoryId integer NOT NULL, CONSTRAINT fk_EventCategory_Id FOREIGN KEY(EventCategoryId) REFERENCES EventCategories(Id));`;
